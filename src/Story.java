public class Story {
  ...
  Story() {
    ...
    start_story.direction[0] = new Situation("Первая дверь",
              "Вы открываете первую дверь и видите перед собой длинную тёмную лестницу.\n"
                    ...
                    + "Артурчик разозлился и дал вам сковородой по голове. Вы мертвы", 0, +20, -10, 0);
    start_story.direction[1] = new Situation("Вторая дверь",
    ...
    start_story.direction[2] = new Situation("Третья дверь",
            "Вы открываете красную дверь и попадаете в прекрасный сад. В саду цветут цветы, поют птицы\n"
                    ...
                    + "какое то существо. Это существо смотрело на вас. С каждым миганием света вы всё больше и больше ощущали страх.\n"
                    + "Непонятное существо встало с табурета и взяло вас за руку. Оно сказало..."
                    + "После данного заявления вам не нашлось что сказать и вы пошли за клубникой.", 0, -30, 0, 1);
